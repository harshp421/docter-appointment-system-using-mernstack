    ...
    <div class="row">
      <div class="col-md-12 docter-box theam-color" >
        <div class="block text-center">
          ...
          <h1 class="text-capitalize text-white mb-5 text-lg">Dr.{doctor?.firstName} {doctor?.lastName}</h1>
         </div>
      </div>
    </div>
  </div>
...
<section className="doctor-single home-wrapper-2">
	<div class="container">
		<div class="row">
            ...
            <Link class="docter-btn" to={`/doctor/book-appointment/${doctor?._id}`}>Make An Appointment</Link>
    				</div>
			</div>
		</div>
	</div>
...
<section class="section doctor-skills py-5 home-wrapper-2">
	<div class="container">
		<div class="row">
          ...
          <div class="divider my-2" style={{backgroundColor:"white"}}></div>
					<ul class="list-unstyled lh-35">
						<li class="d-flex justify-content-between align-items-center">
							<span>Monday - Friday</span>
							<span>{doctor?.stiming}-{doctor?.etiming}</span>
						</li>
						<li class="d-flex justify-content-between align-items-center">
							<span>Saturday</span>
